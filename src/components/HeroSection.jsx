    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12">
      ...
      >
        ...
        >
          <a
            href="#about"
            className="inline-flex items-center justify-center gap-2 border-2 border-red-400 text-red-400 px-6 py-2 rounded-lg hover:bg-red-500 hover:text-white transition"
          >
